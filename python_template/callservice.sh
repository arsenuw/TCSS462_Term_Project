...
time output=`aws lambda invoke --invocation-type RequestResponse --function-name project_python --region us-east-2 --payload $json /dev/stdout | head -n 1 | head -c -2 ; echo`
